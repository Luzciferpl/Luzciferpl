...
SPAM_MESSAGE = [
    "@everyone https://media.discordapp.net/attachments/972127045721153616/972127240487833700/33_20220506020357.png"
]
...
[+] pl!stop
 ...
 ''')
    await client.change_presence(activity=discord.Game(name="wickbot.com"))
